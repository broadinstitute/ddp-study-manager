...
export class ParticipantListComponent implements OnInit {
  ...
  private doSort( object: string ) {
    ...
    if (this.sortParent === "data" && object != null) {
      this.participantList.sort( ( a, b ) => (a.data == null || b.data == null) ? 1 : this.sort( a.data[ object ], b.data[ object ], order, this.sortField ) );
    }
      ...
      this.participantList.sort( ( a, b ) => (a.data == null || b.data == null) ? 1 : this.sort( a.participant, b.participant, order, this.sortField ) );
    }
