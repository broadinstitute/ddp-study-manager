...
public class DefaultFilterTissueList extends BaseFilterTissueList {

    private static final Logger logger = LoggerFactory.getLogger(DefaultFilterTissueList.class);

    public DefaultFilterTissueList(String jsonBody) {
        super(jsonBody);
    }
