...
export class Filter {
  ...
  public copy(): Filter {
    ...
    if (this.selectedOptions != null && this.selectedOptions != undefined) {
      for (let s of this.selectedOptions) {
    ...
    let filter2: NameValue = this.filter2 != null && this.filter2 != undefined ? new NameValue( this.filter2.name, this.filter2.value ) : this.filter2;
    let filter1: NameValue = this.filter1 != null && this.filter1 != undefined ? new NameValue( this.filter1.name, this.filter1.value ) : this.filter1;
