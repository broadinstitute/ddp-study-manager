...
public class PatchRoute extends RequestHandler {
    ...
    public PatchRoute(@NonNull Auth0Util auth0Util, @NonNull NotificationUtil notificationUtil, @NonNull PatchUtil patchUtil) {
    ...
    public Object processRequest(Request request, Response response, String userId, String userMail) throws Exception {
        ...
        //Route needs to check it's own permissions, because of multiple ones. UserId is already checked!
        if (UserUtil.checkUserAccess(null, userId, "mr:request") || UserUtil.checkUserAccess(null, userId, "mr:abstraction")
                || UserUtil.checkUserAccess(null, userId, "mr:qc")) {
            try {
